...
hf_with_ha_flag as (
    ...
    from hf_with_teams as t1
    left join games as t2
        on
...
final as (
    ...
    left join players as t3
        on
            t1.player_1_name = t3.player_name
            and t2.game_id = t3.game_id
            and t1.home_team_id = t3.team_id
    left join players as t4
        on
            t1.player_2_name = t4.player_name
            and t2.game_id = t4.game_id
            and t1.away_team_id = t4.team_id
